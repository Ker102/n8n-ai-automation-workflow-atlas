  ...
  <main class="app-shell">
    <header class="hero">
      ...
      <div class="repo-actions">
        <a href="https://github.com/Ker102/n8n-ai-automation-workflow-atlas" target="_blank" rel="noopener" class="repo-btn">
        ...
        <a href="https://github.com/Ker102/n8n-ai-automation-workflow-atlas" target="_blank" rel="noopener" class="repo-btn star-btn">
